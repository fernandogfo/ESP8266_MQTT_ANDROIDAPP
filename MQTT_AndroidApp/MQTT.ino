...
#define L1 0   //pino de saida para acionamento da Lampada L1
 
//informações da rede WIFI
const char* ssid = "FENIX";                 //SSID da rede WIFI
const char* password =  "Rebirth@0106";    //senha da rede wifi
 
//informações do broker MQTT - Verifique as informações geradas pelo CloudMQTT
const char* mqttServer = "m13.cloudmqtt.com";   //server
const char* mqttUser = "lyfyilbg";              //user
const char* mqttPassword = "3ODCmvnSvdZe";      //password
const int mqttPort = 19251;                     //port
